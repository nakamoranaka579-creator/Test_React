...
export default function Home() {
    ...
    >
      <div className="carousel-indicators">
        <button
          ...
          aria-label="Slide 1"
        >
          <img className="img-fluid" src="/BIU1.png" alt="Image" />
        </button>
        <button
          type="button"
          data-bs-target="#header-carousel"
          ...
          aria-label="Slide 2"
        >
          <img className="img-fluid" src="/1.jpg" alt="Image" />
        </button>
        <button
          type="button"
          data-bs-target="#header-carousel"
          ...
          aria-label="Slide 3"
        >
         <img className="img-fluid" src="/2.jpg" alt="Image" />
        </button>
      </div>
      <div className="carousel-inner">
        <div className="carousel-item active">
          <video
            ...
            loop
            playsInline
            style={{ height: "min(650px, 62vw)", minHeight: 480, objectFit: "cover" }}
          >
            <source src="/IMG_3293.MP4" type="video/mp4" />
        ...
        <img className="img-fluid" src="/1.jpg" alt="Image" />
          <div className="carousel-caption">
            <h1 className="display-1 text-uppercase text-white mb-4 animated zoomIn">
             សាកលវិទ្យាល័យ​ ប៊ែលធី អន្តរជាតិ BELTEI International University
      ...
      <div className="row g-5">
        <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
          <div className="about-img">
            <img className="img-fluid w-100" src="/dr_lychheng.jpg" />
          </div>
        </div>
        <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
          ...
          <p className="mb-4">
           សូមគោរព និងសូមស្វាគមន៍ សម្តេច ឯកឧត្តម   លោកឧកញ៉ា  លោកជំទាវ  លោក លោកស្រី អ្នកនាង  កញ្ញា   ជាថ្នាក់ដឹកនាំ មន្ត្រីរាជការ បុគ្គលិក សាស្រ្តាចារ្យ លោកគ្រូ អ្នកគ្រូបុគ្គលិកអង្គការមិនមែនរដ្ឋាភិបាល និងសិស្ស-និស្សិតទាំងអស់ដែលបានសម្រេចចិត្តបន្តការសិក្សាថ្នាក់ឧត្តមសិក្សានៅសាកលវិទ្យាល័យ ប៊ែលធី អន្តរជាតិ ដើម្បីបង្កើនចំណេះដឹង សមត្ថភាពនិងសម្រេចគោលដៅរបស់ខ្លួនទៅថ្ងៃអនាគត។សាកលវិទ្យាល័យ ប៊ែលធី អន្តរជាតិ បានបង្កើតឡើង ក្នុងគោលបំណងរួមចំណែកអភិវឌ្ឍវិស័យអប់រំថ្នាក់ឧត្តមសិក្សានៅប្រទេសកម្ពុជា និងដើម្បីបង្កើនមូលធនមនុស្សប្រកបដោយ “គុណភាព ប្រសិទ្ធភាព ឧត្តមភាព សីលធម៌ និងគុណធម៌”
          </p>
          ...
          <div className="row mt-4 g-3">
            <div className="col-md-6">
              ...
              <p className="mb-2 text-start">
                <i className="fa fa-check-square text-primary me-3" />
                ៣. សេដ្ឋកិច្ច និងគ្រប់គ្រង
              </p>
              <p className="mb-2 text-start">
                <i className="fa fa-check-square text-primary me-3" />
                ៤. បច្ចេកវិទ្យា និងប្រព័ន្ធផ្សព្វផ្សាយ
              </p>
              <p className="mb-2 text-start">
                <i className="fa fa-check-square text-primary me-3" />
                ៥. សារពើភ័ណ្ឌ និងផ្សព្វផ្សាយ
              </p>
              <p className="mb-0 text-start">
                <i className="fa fa-check-square text-primary me-3" />
                ៦. សេដ្ឋកិច្ច និងគ្រប់គ្រង
              </p>
            </div>
            <div className="col-md-6">
              <p className="mb-2 text-start">
                <i className="fa fa-check-square text-primary me-3" />
                ៧. គ្រប់គ្រងហិរញ្ញវត្ថុ
              </p>
              <p className="mb-2 text-start">
                <i className="fa fa-check-square text-primary me-3" />
                ៨. ភាសា និងសីលធម៌
              ...
              <p className="mb-2 text-start">
                <i className="fa fa-check-square text-primary me-3" />
                ៩. គ្រប់គ្រងទំនាក់ទំនង
              </p>
              <p className="mb-2 text-start">
                <i className="fa fa-check-square text-primary me-3" />
                ១០. វិទ្យាសាស្ត្រនិងបច្ចេកវិជ្ជា
              </p>
              <p className="mb-2 text-start">
                <i className="fa fa-check-square text-primary me-3" />
                ១១. គុណភាព និងសេវាកម្ម
              </p>
              <p className="mb-0 text-start">
                <i className="fa fa-check-square text-primary me-3" />
                ១២. ការអប់រំជំរុញច្នៃប្រឌិត
              </p>
            </div>
          </div>
          <div className="border border-5 border-primary p-4 text-center mt-4">
            <h4 className="lh-base text-uppercase mb-0">
              ស្ថាបនិកប៊ែលធី គ្រុបប្រធានក្រុមប្រឹក្សាភិបាល
            </h4>
            <img className="img-fluid" src="/Screenshot 2026-09-08 194604.png" alt="Image" />
            <h4 className="lh-base text-uppercase mb-0">
              <h1>បណ្ឌិត លី ឆេង </h1>
            </h4>
          </div>
    ...
    <div className="container pt-4">
      <div className="row g-0 feature-row wow fadeIn" data-wow-delay="0.1s">
        <div className="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
          ...
          <div className="feature-icon btn-xxl-square mb-4 mt-n4">
  <img className="img-fluid" src="/3.png" alt="Image" />
</div>
        ...
        <div className="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.4s">
          <div className="feature-item border h-100">
            <div className="feature-icon btn-xxl-square  mb-4 mt-n4">
  <img className="img-fluid" src="/images (6).jpeg" alt="Image" />
</div>
            <div className="p-5 pt-0">
        ...
        <div className="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
          <div className="feature-item border h-100">
           <div className="feature-icon btn-xxl-square  mb-4 mt-n4">
  <img className="img-fluid" src="/images (7).jpeg" alt="Image" />
</div>
            <div className="p-5 pt-0">
        ...
        <div className="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.6s">
          <div className="feature-item border h-100">
           <div className="feature-icon btn-xxl-square  mb-4 mt-n4">
  <img className="img-fluid" src="/47fea369-e.jpg" alt="Image" />
</div>
            <div className="p-5 pt-0">
  ...
  <div
    ...
    style={{
  backgroundImage:
    "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('/e7e6a13d-d.jpg')",
        ...
        <div className="col-lg-6 pt-5">
          <div className="mt-5">
            <h1
              ...
              data-wow-delay="0.3s"
            >
           <h1> ហេតុអ្វីសិក្សានៅសាកលវិទ្យាល័យ ប៊ែលធី អន្តរជាតិ?
</h1>  

            </h1>
         <p
  className="text-light mb-4 wow fadeIn"
  style={{
  ...
  data-wow-delay="0.4s"
>
 ១. អគារសិក្សាសាកលវិទ្យាល័យគ្រប់ទីតាំងជាកម្មសិទ្ធិរបស់ប៊ែលធី គ្រុប

២. មានរចនាសម្ព័ន្ធគ្រប់គ្រងត្រឹមត្រូវ និងច្បាស់លាស់ 

៣. មានកម្មវិធីសិក្សាជាភាសាជាតិ និងអន្តរជាតិ

៤. បង្រៀនតាមវិធីសាស្ត្រដ៏ពេញនិយមទាំង៣ គឺ៖

          - សិក្សាផ្ទាល់នៅក្នុងថ្នាក់ (On-Campus Learning)

          - សិក្សាតាមប្រព័ន្ធអេឡិចត្រូនិក (Online Learning)

          - សិក្សាតាមបែបចម្រុះ (Blended Learning)

៥. មានមហាវិទ្យាល័យធំៗចំនួន១២ ជាមួយនឹង ៤២ មុខជំនាញ៖

   ១. គ្រប់គ្រងពាណិជ្ជកម្ម       ៧.ព័ត៌មានវិទ្យា និងវិទ្យាសាស្ត្រ 

   ២. ហិរញ្ញវត្ថុ និងធនាគារ     ៨. បច្ចេកវិទ្យាឌីជីថល និងទូរគមនាគមន៍

   ៣. សេដ្ឋកិច្ច                     ៩.វិស្វកម្ម

   ៤. ច្បាប់                                     ១០. ស្ថាបត្យកម្ម

   ៥.អប់រំ សិល្បៈ និងមនុស្សសាស្ត្រ      ១១.ទំនាក់ទំនងអន្តរជាតិ 

   ៦.ទេសចរណ៍ និងបដិសណ្ឋារកិច្ច      ១២. អាកាសចរស៊ីវិល         ១៣. ភាសាចិន

៦. សាស្ត្រាចារ្យខ្មែរនិងបរទេសមានសញ្ញាបត្រថ្នាក់បណ្ឌិត និងមានបទពិសោធន៍បង្រៀនច្រើនឆ្នាំ
</p>
    ...
    <div className="container">
      ...
      <div className="row g-4">
        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div className="service-item">
            <div className="service-inner pb-5">
              <img className="img-fluid w-100" src="/page_2 (1).png" alt="" />
        ...
        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
          <div className="service-item">
            <div className="service-inner pb-5">
              <img className="img-fluid w-100" src="images_8_264x177_top.jpg" alt="" />
              <div className="service-text px-5 pt-4">
        ...
        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
          <div className="service-item">
             <div className="service-inner pb-5">
              <img className="img-fluid w-100" src="ca2d9ede_264x177_center.jpg" alt="" />
              <div className="service-text px-5 pt-4">
        ...
        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
          <div className="service-item">  
            <div className="service-inner pb-5">
              <img className="img-fluid w-100" src="images12_264x177_center.jpg" alt="" />
              <div className="service-text px-5 pt-4">
        ...
        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div className="service-item"> 
            <div className="service-inner pb-5">
              <img className="img-fluid w-100" src="images13_264x177_center.jpg" alt="" />
              <div className="service-text px-5 pt-4">
                <h5 className="text-uppercase">Steel welding</h5>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        ...
        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
          <div className="service-item">  
 <div className="service-inner pb-5">
              <img className="img-fluid w-100" src="imagepng_264x177_center.jpg" alt="" />
              <div className="service-text px-5 pt-4">
        ...
        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
          <div className="service-item">   
            <div className="service-inner pb-5">
              <img className="img-fluid w-100" src="crowd_264x177_lower.jpg" alt="" />
              <div className="service-text px-5 pt-4">
                <h5 className="text-uppercase">Custom Welding</h5>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        ...
        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
          <div className="service-item"> 
            <div className="service-inner pb-5">
              <img className="img-fluid w-100" src="twogirls_264x177_center.jpg" alt="" />
              <div className="service-text px-5 pt-4">
                <h5 className="text-uppercase">Pipe Welding</h5>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
    ...
    <div className="container">
      ...
      <div className="row g-4">
        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
          <div className="team-item">
            <div className="position-relative overflow-hidden">
              <img className="img-fluid w-100" src="photo_2025-12-05_18-02-15.jpg" alt="" />
        ...
        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
          <div className="team-item">
            <div className="position-relative overflow-hidden">
              <img className="img-fluid w-100" src="photo_2026-07-03_09-05-41.jpg" alt="" />
              <div className="team-social">
                <a className="btn btn-square btn-dark mx-1" href="">
                  <i className="fab fa-facebook-f" />
                </a>
        ...
        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
          <div className="team-item">
            <div className="position-relative overflow-hidden">
              <img className="img-fluid w-100" src="photo_2026-08-09_07-51-28.jpg" alt="" />
              <div className="team-social">
                <a className="btn btn-square btn-dark mx-1" href="">
                  <i className="fab fa-facebook-f" />
                </a>
        ...
        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
          <div className="team-item">
            <div className="position-relative overflow-hidden">
              <img className="img-fluid w-100" src="photo_2025-02-21_09-22-34.jpg" alt="" />
              <div className="team-social">
                <a className="btn btn-square btn-dark mx-1" href="">
                  <i className="fab fa-facebook-f" />
                </a>
        ...
        <div className="col-lg-5 wow fadeInUp" data-wow-delay="0.3s">
          <div className="testimonial-img">
            <div className="animated flip infinite">
              <img className="img-fluid" src="278b2e94-c.jpg" alt="" />
            </div>
            <div className="animated flip infinite">
              <img className="img-fluid" src="664108ec-0.jpg" alt="" />
            </div>
            <div className="animated flip infinite">
              <img className="img-fluid" src="d8ed0e3f-7.jpg" alt="" />
            </div>
            <div className="animated flip infinite">
              <img className="img-fluid" src="7b47693f-f.jpg" alt="" />
            </div>
          </div>
        </div>
